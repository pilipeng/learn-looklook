...
type RegisterReq struct {
	...
	AuthKye  string `protobuf:"bytes,4,opt,name=authKye,proto3" json:"authKye"`
...
func (x *RegisterReq) GetAuthKye() string {
	if x != nil {
		return x.AuthKye
	}
	return ""
...
type LoginResp struct {
	...
	AccessTokey  string `protobuf:"bytes,1,opt,name=accessTokey,proto3" json:"accessTokey"`
	AccessExpire int64  `protobuf:"varint,2,opt,name=accessExpire,proto3" json:"accessExpire"`
	RefreshAfter int64  `protobuf:"varint,3,opt,name=refreshAfter,proto3" json:"refreshAfter"`
}
...
func (x *LoginResp) GetAccessTokey() string {
	if x != nil {
		return x.AccessTokey
	}
	return ""
}
...
var file_usercenter_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x4b, 0x79, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x75,
	0x74, 0x68, 0x4b, 0x79, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x61, 0x75, 0x74, 0x68, 0x54, 0x79, 0x70,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x61, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x79, 0x12, 0x22, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x65,
